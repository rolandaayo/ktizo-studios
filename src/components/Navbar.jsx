        ...
        <div>
          <section className=" ">
            <nav className='flex justify-between items-center'>
              ...
              <a className='w-40' href="in.html"><img src="/images/KTIZO studio.png" alt="Logo"/></a>
            ...
            <div className="flex-col text-center bg- ">
          ...
          <div className=" ">
            ...
            <img className=" " src="/images/DSC07907-Edit.jpg" alt="" />
          </div>
          {/* ABOUT THE STUDIO */}

          <div className="section">
            <img className=" " src="/images/IMG_7955.jpg" alt="" />
